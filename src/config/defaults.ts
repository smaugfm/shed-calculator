...
export function defaultConfig(): ShedConfig {
  ...
  return {
    ...
    walls: { studSpacing: 600, osbThickness: 11, facadeType: 'cladding', topPlateCount: 2, bottomPlateCount: 1 },
    roof: { type: 'mono-pitch', covering: 'shingles', rafterSpacing: 600, osbThickness: 18, overhang: 150 },
    openings: [
